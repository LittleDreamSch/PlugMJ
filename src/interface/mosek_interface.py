"""
MOSEK OPTIMIZER INTERFACE

API: https://docs.mosek.com/latest/pythonapi/intro_info.html
"""

# NOTE: SDP 问题不支持自动对偶 https://docs.mosek.com/latest/pythonfusion/presolver.html#index-4
